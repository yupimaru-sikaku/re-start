...
export const CreatePdf = async (pdfUrl: string, behavior: ReturnBehavior) => {
  ...
  // const infoArr = [
  //   { value: behavior.name, x: 285, y: 810 },
  //   { value: convertYear.toString(), x: 71, y: 827 },
  //   { value: behavior.month!.toString(), x: 107, y: 827 },
  // ];
  ...
  // // 契約支給量
  // const serviceArr = [
  //   { value: behavior.amount_title_1 || '', x: 82, y: 783 },
  //   {
  //     value: behavior.amount_value_1
  //       ? behavior.amount_value_1.toString()
  //       : '',
  //     x: 268,
  //     y: 783,
  //   },
  //   { value: behavior.amount_title_2 || '', x: 82, y: 771 },
  //   {
  //     value: behavior.amount_value_2
  //       ? behavior.amount_value_2.toString()
  //       : '',
  //     x: 268,
  //     y: 771,
  //   },
  //   { value: behavior.amount_title_3 || '', x: 82, y: 759 },
  //   {
  //     value: behavior.amount_value_3
  //       ? behavior.amount_value_3.toString()
  //       : '',
  //     x: 268,
  //     y: 759,
  //   },
  ...
  //   calcEachWorkTime(behavior.content_arr);
