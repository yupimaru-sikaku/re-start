...
export const CreatePdf = async (
  ...
  // const fontSize = 10;
  // // 年、月、名前
  // const convertYear = mobility.year! - 2018;
  // const infoArr = [
  //   { value: mobility.name, x: 285, y: 810 },
  //   { value: convertYear.toString(), x: 71, y: 827 },
  //   { value: mobility.month!.toString(), x: 107, y: 827 },
  // ];
  ...
  // // 契約支給量
  // const serviceArr = [
  //   { value: mobility.amount_title_1 || '', x: 82, y: 783 },
  //   {
  //     value: mobility.amount_value_1
  //       ? mobility.amount_value_1.toString()
  //       : '',
  //     x: 268,
  //     y: 783,
  //   },
  //   { value: mobility.amount_title_2 || '', x: 82, y: 771 },
  //   {
  //     value: mobility.amount_value_2
  //       ? mobility.amount_value_2.toString()
  //       : '',
  //     x: 268,
  //     y: 771,
  //   },
  //   { value: mobility.amount_title_3 || '', x: 82, y: 759 },
  //   {
  //     value: mobility.amount_value_3
  //       ? mobility.amount_value_3.toString()
  //       : '',
  //     x: 268,
  //     y: 759,
  //   },
  ...
  // });
  // // 受給者証番号
  // const numberArr = mobility.identification.split('');
  ...
  // });
  // // 日付毎の記録
  // const contentArr = mobility.content_arr.map((content) => {
  //   return {
  //     work_date: `${
  ...
  //   calcEachWorkTime(mobility.content_arr);
